...
import com.uowee.tangram.finder.LayoutHelperFinder;
import com.uowee.tangram.finder.RangeLayoutHelperFinder;
import com.uowee.tangram.helper.BaseLayoutHelper;
import com.uowee.tangram.helper.DefaultLayoutHelper;
import com.uowee.tangram.helper.FixAreaAdjuster;
import com.uowee.tangram.helper.FixAreaLayoutHelper;
...
public class VirtualLayoutManager extends ExposeLinearLayoutManagerEx implements LayoutManagerHelper {
    ...
    @Override
    protected void layoutChunk(RecyclerView.Recycler recycler, RecyclerView.State state, LayoutState layoutState, com.uowee.tangram.LayoutChunkResult result) {
    ...
    public static class LayoutStateWrapper {
        ...
        /**
         * This {@link #layoutChunk(RecyclerView.Recycler, RecyclerView.State, LayoutState, com.uowee.tangram.LayoutChunkResult)} pass is in layouting or scrolling
         */
