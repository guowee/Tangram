...
class ExposeLinearLayoutManagerEx extends LinearLayoutManager {
    ...
    private static final String TAG = "ExposeLayoutManagerEx";
...
//        setItemPrefetchEnabled(false);
    ...
    private com.uowee.tangram.LayoutChunkResult layoutChunkResultCache
            = new com.uowee.tangram.LayoutChunkResult();
    ...
    protected void layoutChunk(RecyclerView.Recycler recycler, RecyclerView.State state,
                               LayoutState layoutState, com.uowee.tangram.LayoutChunkResult result) {
