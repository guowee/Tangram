...
import com.muse.tangram.finder.LayoutHelperFinder;
import com.muse.tangram.finder.RangeLayoutHelperFinder;
import com.muse.tangram.helper.BaseLayoutHelper;
import com.muse.tangram.helper.DefaultLayoutHelper;
import com.muse.tangram.helper.FixAreaAdjuster;
import com.muse.tangram.helper.FixAreaLayoutHelper;
...
public class VirtualLayoutManager extends ExposeLinearLayoutManagerEx implements LayoutManagerHelper {
    ...
    @Override
    protected void layoutChunk(RecyclerView.Recycler recycler, RecyclerView.State state, LayoutState layoutState, com.muse.tangram.LayoutChunkResult result) {
    ...
    public static class LayoutStateWrapper {
        ...
        /**
         * This {@link #layoutChunk(RecyclerView.Recycler, RecyclerView.State, LayoutState, com.muse.tangram.LayoutChunkResult)} pass is in layouting or scrolling
         */
