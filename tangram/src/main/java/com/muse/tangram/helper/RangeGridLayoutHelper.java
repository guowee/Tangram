...
package com.muse.tangram.helper;
...
import com.muse.tangram.helper.GridLayoutHelper.SpanSizeLookup;
import com.muse.tangram.Range;
import com.muse.tangram.VirtualLayoutManager.LayoutParams;

import com.muse.tangram.LayoutChunkResult;
import com.muse.tangram.LayoutManagerHelper;
import com.muse.tangram.OrientationHelperEx;
...
public class RangeGridLayoutHelper extends BaseLayoutHelper {
    ...
    @Override
    public void layoutViews(Recycler recycler, State state, VirtualLayoutManager.LayoutStateWrapper layoutState, LayoutChunkResult result, LayoutManagerHelper helper) {
        ...
        final boolean layoutStart = layoutState.getLayoutDirection() == VirtualLayoutManager.LayoutStateWrapper
                .LAYOUT_START;
        int consumedGap = 0;
        if (!mLayoutWithAnchor) {
            if (!layoutStart) {
